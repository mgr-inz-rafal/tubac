...
|GOSUB|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`||
|GOTO|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`|Only direct jumps to line numbers. GOTO A+8 is not (and will not be) supported. I did it once in the past, just for fun, but it didn't bring any value besides slowing the GOTO down tremendously.|
|GRAPHICS|![#f03c15](https://placehold.it/15/f03c15/000000?text=+) `Not supported`||
|IF...THEN|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`||
...
|NEXT|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`||
...
|PEEK|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`||
...
|POKE|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`||
...
|RETURN|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`||
...
|SOUND|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`|Seems to be producing incorrect sounds... Need to investigate more.|
...
|STEP|![#00ff00](https://placehold.it/15/00ff00/000000?text=+) `Supported`||
